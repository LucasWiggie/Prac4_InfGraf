...
void destroy()
{
	...
	// Todo lo que hemos creado para el postproceso de shaders etc. se eliminará
...
void initShaderPP(const char* vname, const char* fname) {
	...
	// ID's de los shaders y el programa
	...
	// Activamos los dos shaders como parte del programa
	...
	// Comprobación de si se ha linkeado bien
	int linked;
